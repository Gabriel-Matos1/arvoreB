...
//NA DOCUMENTAÇÃO TÁ ESCRITO CRIR AO INVES DE CRIAR -> PERGUNTAR PARA O PROFESSOR QUAL O FORMATO CERTO
struct arvoreB* criarArvoreB(int32_t t_arvore);//Aloca uma struct do tipo arvoreB com um valor de T específico e a retorna.
